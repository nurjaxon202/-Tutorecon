...
export default [
  ...
  q('fm53', 'mi5.1', 1, 'In the market for labor, which statement is true?', [
    ['Firms supply labor and households demand it', 'The roles are the other way around in factor markets.'],
    ['The government sets every wage', 'Wages are mostly set by supply and demand.'],
    ['Households supply labor, and firms demand it', 'Correct. In factor markets, households sell their labor and other resources, and firms buy them to make goods.'],
    ['Households and firms both supply labor', 'Firms buy labor. They do not supply it.'],
    ['Labor is traded in the product market', 'Labor is a factor of production, so it is traded in a factor market.'],
  ], 2),
  q('fm54', 'mi5.1 mi5.2', 2, 'A popular low-carb diet sharply cuts the demand for bread. What happens in the market for bakery workers?', [
    ['Demand for bakery workers rises, because bakeries need to advertise', 'Less demand for bread makes bakers less valuable to bakeries.'],
    ['Supply of bakery workers falls', 'The change starts with buyers of bread, which affects demand for workers.'],
    ['Nothing changes, since the diet affects bread, not workers', 'Demand for workers is derived from demand for what they make.'],
    ['Wages rise because fewer people want to be bakers', 'Nothing here changes how many people want the job.'],
    ['Demand for bakery workers falls, because labor demand is derived from bread demand', 'Correct. Lower bread demand lowers bread prices and output, which lowers the marginal revenue product of bakers.'],
  ], 4),
  q('fm55', 'mi5.1', 1, 'A farmer rents a field to a company that builds a solar farm on it. The payment the farmer receives is called', [
    ['wages', 'Wages are paid for labor.'],
    ['rent', 'Correct. Rent is the payment for the use of land and other natural resources.'],
    ['interest', 'Interest is the payment for capital.'],
    ['profit', 'Profit is the reward for entrepreneurship.'],
    ['a transfer payment', 'The farmer is paid for supplying land, so this is not a transfer.'],
  ], 1),
  q('fm56', 'mi5.1 mi5.3', 2, 'The marginal revenue product of a worker depends on', [
    ['only the wage the worker is paid', 'The wage is the cost of the worker. MRP is what the worker adds to revenue.'],
    ['how many hours the owner works', 'The owner’s hours do not set a worker’s MRP.'],
    ['the price of the firm’s stock', 'Stock prices do not determine a worker’s MRP.'],
    ['both the extra output the worker adds and the revenue from each extra unit sold', 'Correct. MRP = marginal product × marginal revenue. A more productive worker or a more valuable product raises it.'],
    ['the number of workers at other firms', 'Other firms’ hiring does not directly set this worker’s MRP.'],
  ], 3),
  q('fm57', 'mi5.1 mi5.3', 3, 'A firm hires workers in a competitive labor market until marginal revenue product equals the wage. The market wage rises, and nothing else changes. What happens?', [
    ['The firm hires fewer workers, moving up along its MRP curve', 'Correct. At the old number of workers, the last worker now costs more than they add, so the firm cuts back until MRP rises to the new wage.'],
    ['The firm hires more workers to finish the work faster', 'A higher wage makes each worker more costly, so the firm hires fewer.'],
    ['The firm’s MRP curve shifts right', 'The wage does not change MRP. The firm moves along the curve.'],
    ['Nothing changes, because MRP stays the same', 'The hiring rule compares MRP with the wage, and the wage changed.'],
    ['The firm must raise the price of its product', 'A competitive firm takes its product price as given.'],
  ], 0),
  q('fm58', 'mi5.1 mi5.2', 2, 'Surgeons earn far more than cashiers. Which explanation fits the factor-market model?', [
    ['Surgeons work longer hours', 'Hours alone do not explain the gap in the wage per hour.'],
    ['Hospitals are required to pay surgeons more', 'The gap comes from supply and demand, not rules.'],
    ['Cashiers are not part of any factor market', 'Cashiers sell their labor in a factor market too.'],
    ['Surgeons are paid more because their demand is derived', 'All labor demand is derived. That alone does not explain the gap.'],
    ['Each surgeon adds much more value, and long training keeps the supply of surgeons small', 'Correct. High marginal revenue product raises demand, and years of costly training limit supply. Both push the wage up.'],
  ], 4),
];
